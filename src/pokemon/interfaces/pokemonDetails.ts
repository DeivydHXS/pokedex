// To parse this data:
//
//   import { Convert, PokemonDetails } from "./file";
//
//   const pokemonDetails = Convert.toPokemonDetails(json);
//
...
export class Convert {
    public static toPokemonDetails(json: string): PokemonDetails {
        return cast(JSON.parse(json), r("PokemonDetails"));
    }

    public static pokemonDetailsToJson(value: PokemonDetails): string {
